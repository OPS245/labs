...
echo "2. A copy of this script output has been created at /root/lab8_output.txt. Submit this file along with your screenshot." | tee -a $logfile
echo
